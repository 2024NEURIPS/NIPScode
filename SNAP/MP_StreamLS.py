...
class MP_StreamLS():
        ...
        for i in range(2,self.passes+1):
            ...
            for id, group in zip(self.data_id,self.data_group):
                if self.counter % 100000 == 0:
                    print(self.counter," ",len(self.S)," ",self.func_value ," ",len(self.element_set)," ",len(self.B))
    ...
    def main(self):
        ...
        file_name = "MP_StreamLS_" + "K=" + str(self.K) + "_gender_PR_output.txt"
...
if __name__ == "__main__":
    ...
    k_list = [100]
    for k in k_list:
        ops = MP_StreamLS(data,relationships,2,k)
        ops.main()
